...
DocumentReference? get currentUserReference =>
    loggedIn ? UserEmailAccountsRecord.collection.doc(currentUser!.uid) : null;

UserEmailAccountsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserEmailAccountsRecord.getDocument(
                  UserEmailAccountsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
